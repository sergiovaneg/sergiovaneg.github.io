...
## <a name="complexity"></a>$\mathcal{O}(C^k)$, and how to Observe it
...
## <a name="concurrent"></a>Brute-Force 2: Concurrent Boogaloo

Before fundamentally changing the solver, I wanted to see how much of an improvement I could get out of *Goroutines*. It doesn't matter what your stance is on Go or how verbose its error-handling is, one thing no one can deny is how ridiculously easy it is to refactor embarrasingly-parallel code and make it concurrent. For example, the `grow` method calls the `transform` function separately for each subsector of the grid; and since the next-generation grid is pre-allocated, making it concurrent requires little to no effort:
...
Solvers/Naïve_Parallel_Solver/2-16              45.98µ ± 2%
Solvers/Naïve_Parallel_Solver/3-16              56.70µ ± 1%
Solvers/Naïve_Parallel_Solver/4-16              69.56µ ± 2%
Solvers/Naïve_Parallel_Solver/5-16              86.76µ ± 1%
Solvers/Naïve_Parallel_Solver/6-16              128.5µ ± 1%
Solvers/Naïve_Parallel_Solver/7-16              185.9µ ± 4%
...
Solvers/Naïve_Parallel_Solver/16-16             56.06m ± 4%
Solvers/Naïve_Parallel_Solver/17-16             102.2m ± 3%
Solvers/Naïve_Parallel_Solver/18-16             188.0m ± 3%
Solvers/Naïve_Parallel_Solver/19-16             304.5m ± 3%
Solvers/Naïve_Parallel_Solver/20-16             484.6m ± 3%
Solvers/Naïve_Parallel_Solver/21-16             889.4m ± 6%
Solvers/Naïve_Parallel_Solver/22-16              1.584 ± 4%
