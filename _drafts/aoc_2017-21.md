...
As I mentioned earlier, there are optimizations left on the table due to Go being a garbage-collected language. Perhaps I'll revisit this problem and extend the results once Zig reaches 1.0. Regardless, I'm satisfied with how intuitive this heuristic was for me, and I hope this wasn't just a fluke.

I will try to do a similar write-up for other problems I find interesting, perhaps using Elixir or trying OCaml instead. For the time being, I should probably go back to work and check how the hyperparameter search is going 🫠.
